    ...
    .then((snapshot) => {
      if (snapshot.exists()) {
        ...
        listUser.forEach((item) => {
          ...
          clientImage.style.backgroundImage = "url(img/User_default.jpg)";
          ...
          const valuePhoneNum = document.createElement("td");
          ...
          btnEdit.addEventListener("click", () => {
            ...
            input_RewritePhoneNum.innerHTML = item.phoneNumber;
          ...
          valuePhoneNum.innerHTML = item.phoneNumber;
          ...
          bodyContentTable.appendChild(valuePhoneNum);
